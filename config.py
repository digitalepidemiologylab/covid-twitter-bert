...
PRETRAINED_MODELS = {
        'bert_large_uncased': {
         ...
         'bert_large_norwegian_uncased': {
            'bucket_location': 'pretrained_models/bert/keras_bert/wwm_uncased_L-24_H-1024_A-16',
            'hub_url': 'tensorflow/wwm_uncased_L-24_H-1024_A-16/2',
            'config': 'bert_config_large_norwegian_uncased.json',
            'is_tfhub_model': True,
        ...
        'bert_base_scandinavian_uncased': {
            'bucket_location': '',
            'hub_url': 'tensorflow/bert_multi_cased_L-12_H-768_A-12/2',
            'config': 'bert_config_base_scandinavian_uncased.json',
            'is_tfhub_model': True,
