...
do
  python run_finetune.py --run_prefix martin_pretrain_2 --model_class bert_large_uncased --finetune_data ${FINETUNE_DATA_V1}/${FINETUNE_DATASET} --train_batch_size $TRAIN_BATCH_SIZE --eval_batch_size $EVAL_BATCH_SIZE --tpu_ip $TPU_IP  --num_epochs $NUM_EPOCHS --learning_rate $LR --init_checkpoint_index 0
  python run_finetune.py --run_prefix martin_pretrain_2 --model_class bert_large_uncased --finetune_data ${FINETUNE_DATA_V1}/${FINETUNE_DATASET} --train_batch_size $TRAIN_BATCH_SIZE --eval_batch_size $EVAL_BATCH_SIZE --tpu_ip $TPU_IP  --num_epochs $NUM_EPOCHS --learning_rate $LR --init_checkpoint ${PRETRAIN_RUN_2}/$INIT_CHECKPOINT_1 --init_checkpoint_index 1
  python run_finetune.py --run_prefix martin_pretrain_2 --model_class bert_large_uncased --finetune_data ${FINETUNE_DATA_V1}/${FINETUNE_DATASET} --train_batch_size $TRAIN_BATCH_SIZE --eval_batch_size $EVAL_BATCH_SIZE --tpu_ip $TPU_IP  --num_epochs $NUM_EPOCHS --learning_rate $LR --init_checkpoint ${PRETRAIN_RUN_2}/$INIT_CHECKPOINT_2 --init_checkpoint_index 2
  python run_finetune.py --run_prefix martin_pretrain_2 --model_class bert_large_uncased --finetune_data ${FINETUNE_DATA_V1}/${FINETUNE_DATASET} --train_batch_size $TRAIN_BATCH_SIZE --eval_batch_size $EVAL_BATCH_SIZE --tpu_ip $TPU_IP  --num_epochs $NUM_EPOCHS --learning_rate $LR --init_checkpoint ${PRETRAIN_RUN_2}/$INIT_CHECKPOINT_3 --init_checkpoint_index 3
  python run_finetune.py --run_prefix martin_pretrain_2 --model_class bert_large_uncased --finetune_data ${FINETUNE_DATA_V1}/${FINETUNE_DATASET} --train_batch_size $TRAIN_BATCH_SIZE --eval_batch_size $EVAL_BATCH_SIZE --tpu_ip $TPU_IP  --num_epochs $NUM_EPOCHS --learning_rate $LR --init_checkpoint ${PRETRAIN_RUN_2}/$INIT_CHECKPOINT_4 --init_checkpoint_index 4
done
