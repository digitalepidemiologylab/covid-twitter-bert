...
do
  ...
  python run_finetune_tf21.py --run_prefix eval_wwm_v4 --bucket_name cb-tpu-projects-us --tpu_ip $TPU_1 --repeats $NUM_REPEATS --model_class $MODEL_CLASS --finetune_data ${FINETUNE_DATA}/${FINETUNE_DATASET} --train_batch_size $TRAIN_BATCH_SIZE --eval_batch_size $EVAL_BATCH_SIZE --num_epochs $NUM_EPOCHS --learning_rate $LR --init_checkpoint_index 0 &
  python run_finetune_tf21.py --run_prefix eval_wwm_v4 --bucket_name cb-tpu-projects-us --tpu_ip $TPU_2 --repeats $NUM_REPEATS --model_class $MODEL_CLASS --finetune_data ${FINETUNE_DATA}/${FINETUNE_DATASET} --train_batch_size $TRAIN_BATCH_SIZE --eval_batch_size $EVAL_BATCH_SIZE --num_epochs $NUM_EPOCHS --learning_rate $LR --init_checkpoint_index 4 --init_checkpoint ${PRETRAIN_RUN}/${INIT_CHECKPOINT_04} &
  python run_finetune_tf21.py --run_prefix eval_wwm_v4 --bucket_name cb-tpu-projects-us --tpu_ip $TPU_3 --repeats $NUM_REPEATS --model_class $MODEL_CLASS --finetune_data ${FINETUNE_DATA}/${FINETUNE_DATASET} --train_batch_size $TRAIN_BATCH_SIZE --eval_batch_size $EVAL_BATCH_SIZE --num_epochs $NUM_EPOCHS --learning_rate $LR --init_checkpoint_index 8 --init_checkpoint ${PRETRAIN_RUN}/${INIT_CHECKPOINT_08} &
  python run_finetune_tf21.py --run_prefix eval_wwm_v4 --bucket_name cb-tpu-projects-us --tpu_ip $TPU_4 --repeats $NUM_REPEATS --model_class $MODEL_CLASS --finetune_data ${FINETUNE_DATA}/${FINETUNE_DATASET} --train_batch_size $TRAIN_BATCH_SIZE --eval_batch_size $EVAL_BATCH_SIZE --num_epochs $NUM_EPOCHS --learning_rate $LR --init_checkpoint_index 12 --init_checkpoint ${PRETRAIN_RUN}/${INIT_CHECKPOINT_12} &
  python run_finetune_tf21.py --run_prefix eval_wwm_v4 --bucket_name cb-tpu-projects-us --tpu_ip $TPU_5 --repeats $NUM_REPEATS --model_class $MODEL_CLASS --finetune_data ${FINETUNE_DATA}/${FINETUNE_DATASET} --train_batch_size $TRAIN_BATCH_SIZE --eval_batch_size $EVAL_BATCH_SIZE --num_epochs $NUM_EPOCHS --learning_rate $LR --init_checkpoint_index 16 --init_checkpoint ${PRETRAIN_RUN}/${INIT_CHECKPOINT_16} &
  python run_finetune_tf21.py --run_prefix eval_wwm_v4 --bucket_name cb-tpu-projects-us --tpu_ip $TPU_6 --repeats $NUM_REPEATS --model_class $MODEL_CLASS --finetune_data ${FINETUNE_DATA}/${FINETUNE_DATASET} --train_batch_size $TRAIN_BATCH_SIZE --eval_batch_size $EVAL_BATCH_SIZE --num_epochs $NUM_EPOCHS --learning_rate $LR --init_checkpoint_index 20 --init_checkpoint ${PRETRAIN_RUN}/${INIT_CHECKPOINT_20} &
  wait
done
