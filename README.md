...
| v2 | BERT-large-uncased-WWM | en | [TF2 Checkpoint](https://crowdbreaks-public.s3.eu-central-1.amazonaws.com/models/covid-twitter-bert/v2/checkpoint_submodel/covid-twitter-bert-v2.tar.gz) |[Huggingface](https://huggingface.co/digitalepidemiologylab/covid-twitter-bert-v2)| :construction: |
